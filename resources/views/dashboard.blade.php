            ...
            <div class="row gx-4">
                <div class="col">
                    <div class="h-100 text-center text-md-start">
                        <h3 class="mb-1">Administradores</h3>
    ...
    <section class="py-3">
        ...
        <div class="row">
            <div class="col-md-8 me-auto text-left">
                ...
                <p>Lista de administradores que gestionan la plataforma y sus respectivos clientes.</p>
            </div>
        </div>
                            ...
                            <div class="card-body p-3">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3 my-auto">
                                        ...
                                        <p class="text-sm text-muted"> {{ $administrador->descripcion }} </p>
                                    </div>
                                </div>
