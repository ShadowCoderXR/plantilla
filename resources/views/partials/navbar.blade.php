<nav class="navbar navbar-main navbar-expand-lg position-sticky mt-4 top-1 px-0 mx-4 shadow-none border-radius-xl z-index-sticky"
     data-scroll="true" id="navbarBlur">
                    ...
                    <a class="opacity-3 text-dark" href="javascript:">
                        <svg class="mb-1" height="12px" version="1.1" viewBox="0 0 45 40" width="12px"
                            ...
                            <g fill="none" fill-rule="evenodd" stroke="none" stroke-width="1">
                                <g fill="#252f40" fill-rule="nonzero"
            ...
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item d-flex align-items-center">
                    <a class="nav-link text-body font-weight-bold px-0"
                       href="../pages/authentication/signin/illustration.html" target="_blank">
                    ...
                    <ul aria-labelledby="dropdownMenuButton"
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:">
                                <div class="d-flex py-1">
                                    <div class="my-auto">
                                        <img alt="user image" class="avatar avatar-sm  me-3 "
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:">
                                <div class="d-flex py-1">
                                    <div class="my-auto">
                                        <img alt="logo spotify"
                                             class="avatar avatar-sm bg-gradient-dark  me-3 " src="{{ asset('img/small-logos/logo-spotify.svg') }}">
                                    </div>
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1">
